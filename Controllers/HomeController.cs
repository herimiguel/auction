...
namespace auction.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Dashboard(){
            ...
            User currentUser = _context.Users.SingleOrDefault(u => u.Id == (int)userId);
        ...
        public IActionResult ShowAuction(string id){
            ...
            Auction showingAuction = _context.Auctions.SingleOrDefault(a => a.Id == auctionId);
        ...
        public IActionResult DeleteAuction(string id){
            int auctionId = Int32.Parse(id);
            Auction deletedAuction = _context.Auctions.SingleOrDefault(a => a.Id == auctionId);
